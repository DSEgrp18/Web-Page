...
export const strings = {
  ...
  // -- practice ---------------------------------------------------------------
  practiceLink: "පුහුණු වන්න",
  practiceHeading: (title: string) => `"${title}" පුහුණු ප්‍රශ්න`,
  practiceHow:
    "මෙම ප්‍රශ්න සාදා ඇත්තේ පොතේම වාක්‍යවලින් එක් වචනයක් ඉවත් කිරීමෙනි. එක් එක් ප්‍රශ්නය පොතේ කොතැනින්ද යන්න ඇසිය හැක.",
  quizzesHeading: "ප්‍රශ්න කට්ටල",
  makeDraftedQuiz: "ආකෘතිය මගින් ප්‍රශ්න සකසන්න",
  draftedHow:
    "ආකෘතිය මගින් සකසන ප්‍රශ්න පොතේ කොටස් බාහිර සේවාවකට යවයි. සෑම ප්‍රශ්නයක්ම පොතේ වාක්‍යයකට එරෙහිව පරීක්ෂා කර, නොගැළපෙන ඒවා ඉවත් කරයි.",
  quizGenerating: "ආකෘතිය ප්‍රශ්න සකසමින් පවතී. මෙය මිනිත්තු කිහිපයක් ගත විය හැක.",
  quizFailed: "ආකෘතියට ප්‍රශ්න සැකසිය නොහැකි විය. ඔබට ඒ වෙනුවට පොතේ වාක්‍යවලින් ප්‍රශ්න සෑදිය හැක.",
  quizDraftedLabel: "ආකෘතිය මගින් සකසා, පොතට එරෙහිව පරීක්ෂා කළා",
  noQuizzes: "තවම ප්‍රශ්න කට්ටල නැත.",
  makeQuiz: "පුහුණු ප්‍රශ්න සාදන්න",
  makeClassQuiz: "පන්තිය සඳහා ප්‍රශ්න සාදන්න",
  quizMade: "ප්‍රශ්න සෑදුවා.",
  quizName: (count: number, forClass: boolean) =>
    forClass ? `පන්තියේ ප්‍රශ්න ${count}ක්` : `මගේ ප්‍රශ්න ${count}ක්`,
  quizDraft: "කෙටුම්පත: සිසුන්ට තවම නොපෙනේ.",
  quizStale: "මෙම ප්‍රශ්න සෑදූ පසු පොත වෙනස් වී ඇත.",
  startQuiz: "ආරම්භ කරන්න",
  reviewQuiz: "සමාලෝචනය කරන්න",
  deleteQuiz: "මකන්න",
  quizDeleted: "ප්‍රශ්න කට්ටලය මකා දැමුණා.",
  questionOf: (index: number, total: number) => `ප්‍රශ්නය ${total} න් ${index}`,
  blankWord: "හිස් තැන",
  checkAnswer: "පරීක්ෂා කරන්න",
  chooseAnswer: "පළමුව පිළිතුරක් තෝරන්න.",
  rightAnswer: "නිවැරදියි.",
  wrongAnswer: (answer: string) => `වැරදියි. නිවැරදි පිළිතුර: ${answer}`,
  hearSource: "මූලාශ්‍රය අසන්න",
  ...
  publishQuiz: "පන්තියට ප්‍රකාශ කරන්න",
  quizPublished: "ප්‍රශ්න පන්තියට ප්‍රකාශ කළා.",
  quizReviewIntro:
    "සිසුන්ට පෙනීමට පෙර එක් එක් ප්‍රශ්නය පරීක්ෂා කරන්න. නුසුදුසු ප්‍රශ්න ඉවත් කරන්න; ප්‍රශ්න සංස්කරණය කළ නොහැක.",
  errorNoQuestions: "මෙම පොතෙන් ප්‍රශ්න සෑදිය නොහැකි විය.",
